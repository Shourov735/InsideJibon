...
export default function Error({
  ...
  return (
    <main id="main-content" className="flex min-h-[60dvh] flex-col items-center justify-center gap-4 px-4 text-center">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link href="/" className="text-sm font-semibold text-primary hover:underline focus-visible:outline-2 focus-visible:outline-[color:var(--color-info)] focus-visible:outline-offset-2 focus-visible:rounded">
          Go home / হোমপেজে যান
        </Link>
      </div>
    </main>
