...
export function EnrollButton({
  ...
  const whatsAppUrl = getWhatsAppEnrollmentUrl(courseTitle, locale);
  ...
  if (status === "pending") {
    return (
      <div className="flex flex-col items-start gap-3 rounded-2xl border border-amber-500/30 bg-amber-500/5 p-4 sm:p-5 max-w-md">
        ...
        <p className="text-xs leading-relaxed text-secondary">
          {t("enrollment.whatsapp.pendingNote")}
        </p>
