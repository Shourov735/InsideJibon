    ...
    >
      ...
      <div className="flex-1 overflow-y-auto py-2">
        <Link
          ...
          className="flex items-center gap-2.5 border-l-2 border-transparent px-4 py-2.5 text-sm font-medium text-on-surface transition-colors hover:bg-surface-container-low hover:text-primary"
        >
          <svg
