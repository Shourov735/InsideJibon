          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex items-center gap-1 shrink-0">
              <button
                ...
                disabled={isPending}
                aria-label={t("teacher.announcements.togglePin")}
                aria-pressed={announcement.isPinned}
                className={cn(
                  "inline-flex h-9 w-9 items-center justify-center rounded-lg transition-colors disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-[color:var(--color-info)] focus-visible:outline-offset-2",
                  announcement.isPinned
                    ? "bg-primary/10 text-primary hover:bg-primary/20"
                    : "text-secondary hover:bg-surface-container hover:text-on-surface"
                )}
              >
                <svg aria-hidden="true" className="h-4 w-4" fill={announcement.isPinned ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={announcement.isPinned ? "1" : "2"}>
              ...
              <button
                ...
                disabled={isPending}
                aria-label={t("teacher.announcements.editAnnouncement")}
                className="inline-flex h-9 w-9 items-center justify-center rounded-lg text-secondary transition-colors hover:bg-surface-container hover:text-primary disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-[color:var(--color-info)] focus-visible:outline-offset-2"
              >
              ...
              <button
                ...
                disabled={isPending}
                aria-label={t("teacher.announcements.deleteAnnouncement")}
                className="inline-flex h-9 w-9 items-center justify-center rounded-lg text-secondary transition-colors hover:bg-red-50 hover:text-red-600 disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-[color:var(--color-info)] focus-visible:outline-offset-2"
              >
                <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
